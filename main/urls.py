...
urlpatterns = [
    ...
    path('img/<slug:game_slug>/<path:img_name>', serve_game_img, name='serve_game_img'),
    path('profile-pic/<slug:game_slug>', serve_game_profile_pic, name='serve_game_profile_pic'),
    path('user-profile-pic/<str:username>', serve_user_profile_pic, name='serve_user_profile_pic'),
